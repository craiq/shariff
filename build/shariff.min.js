...
(function (global){
"use strict";"function"!=typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")}),Object.keys||(Object.keys=function(e){var t=[];for(var i in e)e.hasOwnProperty(i)&&t.push(i);return t});var $=(typeof window !== "undefined" ? window.jQuery : typeof global !== "undefined" ? global.jQuery : null),url=require("url"),Shariff=function(e,t){var i=this;this.element=e,$(e).empty(),this.options=$.extend({},this.defaults,t,$(e).data());var r=[require("./services/addthis"),require("./services/facebook"),require("./services/facebooklike"),require("./services/googleplus"),require("./services/googleplusplus"),require("./services/linkedin"),require("./services/print"),require("./services/xing"),require("./services/flattr"),require("./services/info"),require("./services/mail"),require("./services/pinterest"),require("./services/reddit"),require("./services/tumblr"),require("./services/twitter"),require("./services/whatsapp"),require("./services/diaspora"),require("./services/stumbleupon"),require("./services/bitcoin"),require("./services/more")];this.services=$.map(this.options.services,function(e){var t;return $.each(r,function(r,s){return s=s(i),s.name===e?(t=s,"undefined"!=typeof shariff_l10n&&("undefined"!=typeof shariff_l10n.share&&"share"===t.shareText.en&&$.extend(t.shareText,shariff_l10n.share.shareText),"undefined"!=typeof shariff_l10n[e]&&("undefined"!=typeof shariff_l10n[e].shareText&&"string"!=typeof t.shareText&&$.extend(t.shareText,shariff_l10n[e].shareText),"undefined"!=typeof shariff_l10n[e].title&&"string"!=typeof t.title&&$.extend(t.title,shariff_l10n[e].title),"undefined"!=typeof shariff_l10n[e].desc&&"undefined"!=typeof t.desc&&"string"!=typeof shariff_l10n[e].desc&&$.extend(t.desc,shariff_l10n[e].desc))),null):void 0}),t}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",langFallback:"en",mailUrl:function(){var e=url.parse(this.getURL(),!0);return e.query.view="mail",delete e.search,url.format(e)},mailSubject:function(){return this.getMeta("DC.title")||this.getTitle()},mailBody:function(){return this.getURL()},mediaUrl:null,orientation:"horizontal",referrerTrack:null,services:["facebook","facebooklike","twitter","googleplus","print"],title:function(){return $("head title").text()},twitterVia:null,url:function(){var e=global.document.location.href,t=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return t.length>0&&(t.indexOf("http")<0&&(t=global.document.location.protocol+"//"+global.document.location.host+t),e=t),e}},$socialshareElement:function(){return $(this.element)},getLocalized:function(e,t){return"object"==typeof e[t]?"undefined"==typeof e[t][this.options.lang]?e[t][this.options.langFallback]:e[t][this.options.lang]:"string"==typeof e[t]?e[t]:void 0},getMeta:function(e){var t=$('meta[name="'+e+'"],[property="'+e+'"]').attr("content");return t||""},getInfoUrl:function(){return this.options.infoUrl},getLang:function(){return this.options.lang},getURL:function(){return this.getOption("url")},getOption:function(e){var t=this.options[e];return"function"==typeof t?$.proxy(t,this)():t},getTitle:function(){return this.getOption("title")},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){var e=url.parse(this.options.backendUrl,!0);return e.query.url=this.getURL(),delete e.search,$.getJSON(url.format(e))},_updateCounts:function(e){var t=this;1===$(t.element).find(".facebook").length&&1===$(t.element).find(".facebooklike").length&&(e.facebook=e.facebook-e.facebooklike),$(t.element).addClass("backend"),$.each(e,function(e,i){i>=1e3&&(i=Math.round(i/1e3)+"k"),$(t.element).find("."+e+" a span:first").after($("<span>").addClass("share_count").text(i))})},_addButtonList:function(){var e=this,t=this.$socialshareElement(),i="theme-"+this.options.theme,r="col-"+this.services.length,s=$("<ul>").addClass(i).addClass(r);if("horizontal"!==this.options.orientation&&s.addClass("orientation-"+this.options.orientation),$.each(this.services,function(t,i){var r=$("<li>").addClass("shariff-button").append("<div>").addClass(i.name),n=$("<span>").addClass("share_text").text(e.getLocalized(i,"shareText")),a=$("<a><div>").data("key",t);a.children("div").append(n),"undefined"!=typeof i.shareUrl?a.attr("href",i.shareUrl):a.attr("href","#"),"undefined"!=typeof i.faName&&a.children("div").prepend($("<span>").addClass("fa").addClass(i.faName)),i.popup?a.attr("rel","popup"):i.tooltip?a.attr("rel","tooltip"):i.pageprint?a.attr("rel","pageprint"):i.more?a.attr("rel","more").data("more","true").data("position",s.find("li").length+1):i.blank&&a.attr("target","_blank"),a.attr("title",e.getLocalized(i,"title")),a.attr("role","button"),a.attr("aria-label",e.getLocalized(i,"title")),r.children("div").append(a),s.append(r),i.more&&s.addClass("more-"+s.find("li").length)}),s.on("click",'[rel="popup"]',function(e){e.preventDefault();var t=$(this).attr("href"),i="_blank",r="600",s="460",n="width="+r+",height="+s;global.window.open(t,i,n)}),s.on("click",'[rel="tooltip"]',function(t){t.preventDefault();var i=$(this).attr("href"),r=this,s=0,n=180,a=e.services[$(this).data("key")],o=$("<div>").addClass("shariff-tooltip");"undefined"!==a.width&&$(this).parent().width(a.width),"undefined"!==a.desc&&o.append($("<p>").text(e.getLocalized(a,"desc"))),$(this).closest("div").css("position",""),"#"!==i?o.append($("<iframe>").attr("src",i)):"undefined"!==a.snippet&&o.append(a.snippet),$(window).width()-$(this).offset().left<n&&($(this).closest("div").css("position","static"),o.css("right","4px").css("bottom",$(this).closest("ul").height()-$(this).height()-$(this).position().top+36)),$(this).parent().append(o),$(this).offset().top-$(window).scrollTop()<$(".shariff-tooltip").height()+50&&o.css("bottom","auto").css("top","36px"),$(document).on("click",function(e){$(e.target).closest("li").find("a")[0]!==r&&0===$(e.target).closest(".shariff-tooltip").length&&($(r).siblings(".shariff-tooltip").remove(),$(this).off(e))}),$(".shariff-tooltip iframe").on("load",function(e){s>0&&($(r).siblings(".shariff-tooltip").remove(),$(this).off(e),s=0),s++})}),s.on("click",'[rel="pageprint"]',function(e){e.preventDefault(),window.print()}),s.find(".shariff-button.more").length>0){var n=s.find("li").index(s.find(".shariff-button.more"));s.find("li:nth-child(n+"+(n+2)+")").hide()}s.on("click",'[rel="more"]',function(t){t.preventDefault();var i="true"===$(this).data("more")?!0:!1,r=$(this).data("position"),s=e.services[$(this).data("key")];i?($(this).find(".fa-plus").removeClass("fa-plus").addClass("fa-minus"),$(this).find(".share_text").text(e.getLocalized(s,"lessText")),$(this).closest("ul").find("li:nth-child(n+"+(r+1)+")").show(),$(this).closest("ul").removeClass("more-"+r),$(this).closest("li").appendTo($(this).closest("ul")),$(this).data("more","false")):($(this).find(".fa-minus").removeClass("fa-minus").addClass("fa-plus"),$(this).find(".share_text").text(e.getLocalized(s,"shareText")),$(this).closest("ul").addClass("more-"+r),$(this).closest("li").insertAfter($(this).closest("ul").find("li:nth-child("+(r-1)+")")),$(this).closest("ul").find("li:nth-child(n+"+(r+1)+")").hide(),$(this).data("more","true"))}),t.append(s)}},module.exports=Shariff,global.Shariff=Shariff,$(".shariff").each(function(){"undefined"==typeof this.shariff&&(this.shariff=new Shariff(this))});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
