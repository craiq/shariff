...
"use strict";var url=require("url");module.exports=function(e){var t=e.getMeta("DC.title")||e.getTitle(),r=e.getMeta("DC.creator");r.length>0&&(t+=" - "+r);var i=url.parse("https://www.pinterest.com/pin/create/link/",!0);return i.query.url=e.getURL(),i.query.media=e.getOption("mediaUrl"),i.query.description=t,delete i.search,{popup:!0,shareText:{en:"pin it"},name:"pinterest",faName:"fa-pinterest-p",title:{de:"Bei Pinterest pinnen",en:"Pin it on Pinterest"},shareUrl:url.format(i)+e.getReferrerTrack()}};
